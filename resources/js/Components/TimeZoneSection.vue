...
<template>
    <section class="bg-slate-50 border border-gray-200 rounded-lg shadow-sm text-left mb-6">
        <div class="p-6">
            ...
            <select id="time_zone" v-model="model" required class="w-full border-gray-200 rounded-md shadow-sm focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm">
