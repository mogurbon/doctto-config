          ...
          <div class="w-full md:w-3/4 p-6 bg-slate-50">
            ...
            <div v-if="activeTab === 'hours'">
              ...
              <div v-if="activeDay" class="bg-slate-50 p-4 rounded-lg border border-gray-200 mb-6">
                ...
                <div v-if="Array.isArray(form.hours[activeDay])">
                  <div v-for="(block, idx) in form.hours[activeDay]" :key="idx" class="flex items-center gap-3 mb-3">
                    ...
                    <button type="button" @click="form.hours[activeDay].splice(idx, 1)" class="text-red-500 hover:text-red-700 p-1">
                ...
                <div class="mt-4">
                  <button type="button" @click="form.hours[activeDay].push({ start: '09:00', end: '18:00' })" class="text-sm text-cyan-500 font-medium">+ Añadir bloque</button>
                </div>
              </div>
            </div>
